...
<body>
    ...
    <main>
        ...
        <section>
            <a href="add_restaurant.php" class="button">Tambah Restoran Baru</a>
        </section>
                ...
                <tbody>
                    <?php foreach ($restaurants as $restaurant): ?>
                        <tr>
                            ...
                            <td>
                                <!-- Edit Button -->
                                <a href="edit_restaurant.php?id=<?= $restaurant['id']; ?>" class="button">Edit</a>
                                <!-- Delete Button -->
                                <a href="manage_restaurants.php?delete=<?= $restaurant['id']; ?>" onclick="return confirm('Yakin ingin menghapus?')" class="button">Hapus</a>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                </tbody>
